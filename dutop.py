...
def print_du(path):
    dufile=os.popen('find \'' + path + '\' -maxdepth 1 -mindepth 1 \( -type f -o -type l -o -type d \) -print0 | xargs -r0 du --max-depth 0 -k | grep -v "^0"') # -o OR operator in find command # --max-depth=0 print the total for a directory
    #sudo find /home/rajendra -maxdepth 1 -mindepth 1 -type f -o -type l -o -type d -print0 | xargs -r0 du --max-depth 0 -k | grep -v "^0"
